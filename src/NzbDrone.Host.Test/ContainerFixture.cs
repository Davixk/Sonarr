...
namespace NzbDrone.App.Test
{
    ...
    public class ContainerFixture : TestBase
    {
        ...
        public void should_resolve_scan_event_handlers()
        {
            ...
            // SeriesScannedEvent; resolving them together reproduces the startup path that must not form a
            ...
            _container.GetServices<IHandle<SeriesScannedEvent>>().Should().NotBeEmpty();
        }
